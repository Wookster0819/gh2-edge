    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <div className="flex flex-col gap-[3vh]">
          <motion.h2 
            style={{ fontSize: 'clamp(26px, 5.5vw, 72px)', fontFamily: display, color: '#FAFAF7', opacity: 0.55, margin: 0 }}
          ...
          <motion.h2 
            style={{ fontSize: 'clamp(30px, 6.5vw, 86px)', fontFamily: display, color: '#FAFAF7', marginTop: '2vh', marginBottom: 0, textShadow: '0 2px 40px rgba(0,0,0,0.6)' }}
